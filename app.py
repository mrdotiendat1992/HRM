...
def lay_user(user):
    if user:
        return {
            ...
            "Ngày sinh": user[4] if user[4] else None,
            "Giới tính": user[5],
            "CCCD": user[6],
            "Ngày cấp CCCD": user[7] if user[7] else None ,
            "Nơi cấp": user[8],
            "CMT": user[9],
            "Thường trú": user[10],
            "Thôn xóm": user[11],
            ...
            "Ngày ký HĐ": user[40] if user[40] else None,
            "Ngày hết hạn": user[41] if user[41] else None,
            ...
            "Ngày vào": user[58] if user[58] else None,
            "Ngày nghỉ": user[59]if user[59] else None,
            "Trạng thái": user[60],
            "Ngày vào nối thâm niên": user[61] if user[61] else None,
            "Ngày kí HĐ Thử việc": user[63] if user[63] else None,
            "Ngày hết hạn HĐ Thử việc": user[64] if user[64] else None,
            "Ngày kí HĐ xác định thời hạn lần 1": user[65] if user[65] else None,
            "Ngày hết hạn HĐ xác định thời hạn lần 1": user[66] if user[66] else None,
            "Ngày kí HĐ xác định thời hạn lần 2": user[67] if user[67] else None,
            "Ngày hết hạn HĐ xác định thời hạn lần 2": user[68] if user[68] else None,
            "Ngày kí HĐ không thời hạn": user[69] if user[69] else None,
